...
main(void)
{
  ...
  exit();
  27:	e8 5f 02 00 00       	call   28b <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 36 01 00 00       	call   2a3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 f9 00 00 00       	call   2cb <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 fc 00 00 00       	call   2e3 <fstat>
  close(fd);
 ...
 33c:	89 d1                	mov    %edx,%ecx
{
 ...
 3ae:	56                   	push   %esi
 3af:	57                   	push   %edi
 3b0:	e8 f6 fe ff ff       	call   2ab <write>
  while(--i >= 0)
 ...
 3e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 425:	57                   	push   %edi
 426:	56                   	push   %esi
 427:	e8 7f fe ff ff       	call   2ab <write>
 ...
 47e:	e8 28 fe ff ff       	call   2ab <write>
        putc(fd, c);
 ...
 48f:	57                   	push   %edi
 490:	56                   	push   %esi
 491:	e8 15 fe ff ff       	call   2ab <write>
        putc(fd, c);
 ...
 4fb:	57                   	push   %edi
 4fc:	56                   	push   %esi
 4fd:	e8 a9 fd ff ff       	call   2ab <write>
        while(*s != 0){
 ...
 53c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 53f:	e8 67 fd ff ff       	call   2ab <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 673:	e8 9b fc ff ff       	call   313 <sbrk>
  if(p == (char*)-1)
