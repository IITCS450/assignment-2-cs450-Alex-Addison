...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 59 05 00 00       	call   59b <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 60 0a 00 00       	push   $0xa60
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 47 05 00 00       	call   59b <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 c4 04 00 00       	call   5db <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 bf 04 00 00       	call   5f3 <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 68 04 00 00       	call   5c3 <close>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 a1 03 00 00       	call   5b3 <read>
 ...
 313:	e8 ab 02 00 00       	call   5c3 <close>
    return;
 ...
 469:	31 db                	xor    %ebx,%ebx
{
 ...
 475:	57                   	push   %edi
 476:	6a 00                	push   $0x0
 478:	e8 36 01 00 00       	call   5b3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4dd:	e8 f9 00 00 00       	call   5db <open>
  if(fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 fc 00 00 00       	call   5f3 <fstat>
  close(fd);
 ...
 64c:	89 d1                	mov    %edx,%ecx
{
 ...
 6be:	56                   	push   %esi
 6bf:	57                   	push   %edi
 6c0:	e8 f6 fe ff ff       	call   5bb <write>
  while(--i >= 0)
 ...
 6f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 735:	57                   	push   %edi
 736:	56                   	push   %esi
 737:	e8 7f fe ff ff       	call   5bb <write>
 ...
 78e:	e8 28 fe ff ff       	call   5bb <write>
        putc(fd, c);
 ...
 79f:	57                   	push   %edi
 7a0:	56                   	push   %esi
 7a1:	e8 15 fe ff ff       	call   5bb <write>
        putc(fd, c);
 ...
 80b:	57                   	push   %edi
 80c:	56                   	push   %esi
 80d:	e8 a9 fd ff ff       	call   5bb <write>
        while(*s != 0){
 ...
 84c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 84f:	e8 67 fd ff ff       	call   5bb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 983:	e8 9b fc ff ff       	call   623 <sbrk>
  if(p == (char*)-1)
