...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 6f 03 00 00       	call   3ab <open>
  ...
  57:	e8 37 03 00 00       	call   393 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 02 03 00 00       	call   36b <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  ...
  73:	e8 48 04 00 00       	call   4c0 <printf>
      exit();
  78:	e8 ee 02 00 00       	call   36b <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 df 02 00 00       	call   36b <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 db 02 00 00       	call   38b <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 b9 02 00 00       	call   383 <read>
  ...
  e6:	e8 d5 03 00 00       	call   4c0 <printf>
      exit();
  eb:	e8 7b 02 00 00       	call   36b <exit>
  ...
  f9:	e8 c2 03 00 00       	call   4c0 <printf>
    exit();
  fe:	e8 68 02 00 00       	call   36b <exit>
 ...
 239:	31 db                	xor    %ebx,%ebx
{
 ...
 245:	57                   	push   %edi
 246:	6a 00                	push   $0x0
 248:	e8 36 01 00 00       	call   383 <read>
    if(cc < 1)
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 f6 fe ff ff       	call   38b <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 7f fe ff ff       	call   38b <write>
 ...
 55e:	e8 28 fe ff ff       	call   38b <write>
        putc(fd, c);
 ...
 5db:	57                   	push   %edi
 5dc:	56                   	push   %esi
 5dd:	e8 a9 fd ff ff       	call   38b <write>
        while(*s != 0){
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 67 fd ff ff       	call   38b <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 753:	e8 9b fc ff ff       	call   3f3 <sbrk>
  if(p == (char*)-1)
