...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 61 02 00 00       	call   2cb <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 36 01 00 00       	call   2e3 <read>
    if(cc < 1)
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 465:	57                   	push   %edi
 466:	56                   	push   %esi
 467:	e8 7f fe ff ff       	call   2eb <write>
 ...
 4be:	e8 28 fe ff ff       	call   2eb <write>
        putc(fd, c);
 ...
 53b:	57                   	push   %edi
 53c:	56                   	push   %esi
 53d:	e8 a9 fd ff ff       	call   2eb <write>
        while(*s != 0){
 ...
 57c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 57f:	e8 67 fd ff ff       	call   2eb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6b3:	e8 9b fc ff ff       	call   353 <sbrk>
  if(p == (char*)-1)
