...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 3b 0e 00 00       	call   e6b <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 ce 0d 00 00       	call   e23 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 cc 0d 00 00       	call   e33 <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 98 0d 00 00       	call   e53 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 a6 0d 00 00       	call   e9b <chdir>
  ...
  exit();
     11a:	e8 0c 0d 00 00       	call   e2b <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 a1 0c 00 00       	call   e2b <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 88 0c 00 00       	call   e23 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 80 0c 00 00       	call   e63 <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 26 0c 00 00       	call   e2b <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 1c 0c 00 00       	call   e3b <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 04 0c 00 00       	call   e53 <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	pushl  -0xc(%ebp)
     253:	e8 fb 0b 00 00       	call   e53 <close>
    wait();
     258:	e8 d6 0b 00 00       	call   e33 <wait>
    wait();
     25d:	e8 d1 0b 00 00       	call   e33 <wait>
    break;
    ...
    wait();
     270:	e8 be 0b 00 00       	call   e33 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 c8 0b 00 00       	call   e53 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	pushl  0x10(%ebx)
     290:	ff 73 08             	pushl  0x8(%ebx)
     293:	e8 d3 0b 00 00       	call   e6b <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 b9 0c 00 00       	call   f80 <printf>
      exit();
     2c7:	e8 5f 0b 00 00       	call   e2b <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 70 0b 00 00       	call   e53 <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	pushl  -0xc(%ebp)
     2e7:	e8 b7 0b 00 00       	call   ea3 <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	pushl  -0x10(%ebp)
     2f0:	e8 5e 0b 00 00       	call   e53 <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	pushl  -0xc(%ebp)
     2f9:	e8 55 0b 00 00       	call   e53 <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 42 0b 00 00       	call   e53 <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	pushl  -0x10(%ebp)
     315:	e8 89 0b 00 00       	call   ea3 <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	pushl  -0x10(%ebp)
     31e:	e8 30 0b 00 00       	call   e53 <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	pushl  -0xc(%ebp)
     327:	e8 27 0b 00 00       	call   e53 <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 36 01 00 00       	call   e43 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 f9 00 00 00       	call   e6b <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 fc 00 00 00       	call   e83 <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 c2 00 00 00       	call   e53 <close>
  return r;
...
00000e23 <fork>:
SYSCALL(fork)
     e23:	b8 01 00 00 00       	mov    $0x1,%eax
     e28:	cd 40                	int    $0x40
     e2a:	c3                   	ret    

00000e2b <exit>:
SYSCALL(exit)
     e2b:	b8 02 00 00 00       	mov    $0x2,%eax
     e30:	cd 40                	int    $0x40
     e32:	c3                   	ret    

00000e33 <wait>:
SYSCALL(wait)
     e33:	b8 03 00 00 00       	mov    $0x3,%eax
     e38:	cd 40                	int    $0x40
     e3a:	c3                   	ret    

00000e3b <pipe>:
SYSCALL(pipe)
     e3b:	b8 04 00 00 00       	mov    $0x4,%eax
     e40:	cd 40                	int    $0x40
     e42:	c3                   	ret    

00000e43 <read>:
SYSCALL(read)
     e43:	b8 05 00 00 00       	mov    $0x5,%eax
     e48:	cd 40                	int    $0x40
     e4a:	c3                   	ret    

00000e4b <write>:
SYSCALL(write)
     e4b:	b8 10 00 00 00       	mov    $0x10,%eax
     e50:	cd 40                	int    $0x40
     e52:	c3                   	ret    

00000e53 <close>:
SYSCALL(close)
     e53:	b8 15 00 00 00       	mov    $0x15,%eax
     e58:	cd 40                	int    $0x40
     e5a:	c3                   	ret    

00000e5b <kill>:
SYSCALL(kill)
     e5b:	b8 06 00 00 00       	mov    $0x6,%eax
     e60:	cd 40                	int    $0x40
     e62:	c3                   	ret    

00000e63 <exec>:
SYSCALL(exec)
     e63:	b8 07 00 00 00       	mov    $0x7,%eax
     e68:	cd 40                	int    $0x40
     e6a:	c3                   	ret    

00000e6b <open>:
SYSCALL(open)
     e6b:	b8 0f 00 00 00       	mov    $0xf,%eax
     e70:	cd 40                	int    $0x40
     e72:	c3                   	ret    

00000e73 <mknod>:
SYSCALL(mknod)
     e73:	b8 11 00 00 00       	mov    $0x11,%eax
     e78:	cd 40                	int    $0x40
     e7a:	c3                   	ret    

00000e7b <unlink>:
SYSCALL(unlink)
     e7b:	b8 12 00 00 00       	mov    $0x12,%eax
     e80:	cd 40                	int    $0x40
     e82:	c3                   	ret    
...
00000e8b <link>:
SYSCALL(link)
     e8b:	b8 13 00 00 00       	mov    $0x13,%eax
     e90:	cd 40                	int    $0x40
     e92:	c3                   	ret    

00000e93 <mkdir>:
SYSCALL(mkdir)
     e93:	b8 14 00 00 00       	mov    $0x14,%eax
     e98:	cd 40                	int    $0x40
     e9a:	c3                   	ret    

00000e9b <chdir>:
SYSCALL(chdir)
     e9b:	b8 09 00 00 00       	mov    $0x9,%eax
     ea0:	cd 40                	int    $0x40
     ea2:	c3                   	ret    

00000ea3 <dup>:
SYSCALL(dup)
     ea3:	b8 0a 00 00 00       	mov    $0xa,%eax
     ea8:	cd 40                	int    $0x40
     eaa:	c3                   	ret    

00000eab <getpid>:
SYSCALL(getpid)
     eab:	b8 0b 00 00 00       	mov    $0xb,%eax
     eb0:	cd 40                	int    $0x40
     eb2:	c3                   	ret    

00000eb3 <sbrk>:
SYSCALL(sbrk)
     eb3:	b8 0c 00 00 00       	mov    $0xc,%eax
     eb8:	cd 40                	int    $0x40
     eba:	c3                   	ret    

00000ebb <sleep>:
SYSCALL(sleep)
     ebb:	b8 0d 00 00 00       	mov    $0xd,%eax
     ec0:	cd 40                	int    $0x40
     ec2:	c3                   	ret    

00000ec3 <uptime>:
SYSCALL(uptime)
     ec3:	b8 0e 00 00 00       	mov    $0xe,%eax
     ec8:	cd 40                	int    $0x40
     eca:	c3                   	ret    
     ...
     edc:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     f4e:	56                   	push   %esi
     f4f:	57                   	push   %edi
     f50:	e8 f6 fe ff ff       	call   e4b <write>
  while(--i >= 0)
     ...
     f89:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
     ...
     fc5:	57                   	push   %edi
     fc6:	56                   	push   %esi
     fc7:	e8 7f fe ff ff       	call   e4b <write>
  ...
  write(fd, &c, 1);
    ...
    101e:	e8 28 fe ff ff       	call   e4b <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    102f:	57                   	push   %edi
    1030:	56                   	push   %esi
    1031:	e8 15 fe ff ff       	call   e4b <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    109b:	57                   	push   %edi
    109c:	56                   	push   %esi
    109d:	e8 a9 fd ff ff       	call   e4b <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    10df:	e8 67 fd ff ff       	call   e4b <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1213:	e8 9b fc ff ff       	call   eb3 <sbrk>
  if(p == (char*)-1)
