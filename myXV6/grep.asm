...
main(int argc, char *argv[])
{
  ...
  55:	e8 99 05 00 00       	call   5f3 <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	pushl  (%ebx)
  69:	e8 9d 05 00 00       	call   60b <open>
  ...
  81:	e8 9a 06 00 00       	call   720 <printf>
      exit();
  86:	e8 40 05 00 00       	call   5cb <exit>
  }
  exit();
  8b:	e8 3b 05 00 00       	call   5cb <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 82 06 00 00       	call   720 <printf>
    exit();
  9e:	e8 28 05 00 00       	call   5cb <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 19 05 00 00       	call   5cb <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 d6 03 00 00       	call   5e3 <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 5a 03 00 00       	call   5eb <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 36 01 00 00       	call   5e3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 f9 00 00 00       	call   60b <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 fc 00 00 00       	call   623 <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 c2 00 00 00       	call   5f3 <close>
  return r;
 ...
 67c:	89 d1                	mov    %edx,%ecx
{
 ...
 6ee:	56                   	push   %esi
 6ef:	57                   	push   %edi
 6f0:	e8 f6 fe ff ff       	call   5eb <write>
  while(--i >= 0)
 ...
 729:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 765:	57                   	push   %edi
 766:	56                   	push   %esi
 767:	e8 7f fe ff ff       	call   5eb <write>
 ...
 7be:	e8 28 fe ff ff       	call   5eb <write>
        putc(fd, c);
 ...
 7cf:	57                   	push   %edi
 7d0:	56                   	push   %esi
 7d1:	e8 15 fe ff ff       	call   5eb <write>
        putc(fd, c);
 ...
 83b:	57                   	push   %edi
 83c:	56                   	push   %esi
 83d:	e8 a9 fd ff ff       	call   5eb <write>
        while(*s != 0){
 ...
 87c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 87f:	e8 67 fd ff ff       	call   5eb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9b3:	e8 9b fc ff ff       	call   653 <sbrk>
  if(p == (char*)-1)
