...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 df 03 00 00       	call   41b <open>
  ...
  59:	e8 a5 03 00 00       	call   403 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 70 03 00 00       	call   3db <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	pushl  (%ebx)
  ...
  75:	e8 b6 04 00 00       	call   530 <printf>
      exit();
  7a:	e8 5c 03 00 00       	call   3db <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 49 03 00 00       	call   3db <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 1e 03 00 00       	call   3f3 <read>
 ...
 16f:	e8 bc 03 00 00       	call   530 <printf>
    exit();
 174:	e8 62 02 00 00       	call   3db <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 36 01 00 00       	call   3f3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 f9 00 00 00       	call   41b <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 fc 00 00 00       	call   433 <fstat>
  close(fd);
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4fe:	56                   	push   %esi
 4ff:	57                   	push   %edi
 500:	e8 f6 fe ff ff       	call   3fb <write>
  while(--i >= 0)
 ...
 539:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 575:	57                   	push   %edi
 576:	56                   	push   %esi
 577:	e8 7f fe ff ff       	call   3fb <write>
 ...
 5ce:	e8 28 fe ff ff       	call   3fb <write>
        putc(fd, c);
 ...
 5df:	57                   	push   %edi
 5e0:	56                   	push   %esi
 5e1:	e8 15 fe ff ff       	call   3fb <write>
        putc(fd, c);
 ...
 64b:	57                   	push   %edi
 64c:	56                   	push   %esi
 64d:	e8 a9 fd ff ff       	call   3fb <write>
        while(*s != 0){
 ...
 68c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 68f:	e8 67 fd ff ff       	call   3fb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7c3:	e8 9b fc ff ff       	call   463 <sbrk>
  if(p == (char*)-1)
