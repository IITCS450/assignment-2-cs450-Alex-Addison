...
int main(void){
   ...
   e:	51                   	push   %ecx
  int me = getpid();
   f:	e8 77 03 00 00       	call   38b <getpid>
  int r;
  ...
  r = setpriority(me, 1);
  1b:	50                   	push   %eax
  1c:	e8 da 02 00 00       	call   2fb <setpriority>
  ...
  38:	e8 be 02 00 00       	call   2fb <setpriority>
  ...
  51:	6a 63                	push   $0x63
  53:	53                   	push   %ebx
  54:	e8 a2 02 00 00       	call   2fb <setpriority>
  ...
  exit();
  79:	e8 8d 02 00 00       	call   30b <exit>
  7e:	66 90                	xchg   %ax,%ax
...
static void check(const char *msg, int cond) {
  ...
  aa:	e8 5c 02 00 00       	call   30b <exit>
  af:	90                   	nop
 ...
 1d9:	31 db                	xor    %ebx,%ebx
{
 ...
 1e5:	57                   	push   %edi
 1e6:	6a 00                	push   $0x0
 1e8:	e8 36 01 00 00       	call   323 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 24d:	e8 f9 00 00 00       	call   34b <open>
  if(fd < 0)
 ...
 261:	50                   	push   %eax
 262:	e8 fc 00 00 00       	call   363 <fstat>
  close(fd);
 267:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 26a:	89 c6                	mov    %eax,%esi
  close(fd);
 26c:	e8 c2 00 00 00       	call   333 <close>
  return r;
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	56                   	push   %esi
 4a7:	e8 7f fe ff ff       	call   32b <write>
 ...
 4fe:	e8 28 fe ff ff       	call   32b <write>
        putc(fd, c);
 ...
 50f:	57                   	push   %edi
 510:	56                   	push   %esi
 511:	e8 15 fe ff ff       	call   32b <write>
        putc(fd, c);
 ...
 57b:	57                   	push   %edi
 57c:	56                   	push   %esi
 57d:	e8 a9 fd ff ff       	call   32b <write>
        while(*s != 0){
 ...
 5bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5bf:	e8 67 fd ff ff       	call   32b <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6f3:	e8 9b fc ff ff       	call   393 <sbrk>
  if(p == (char*)-1)
