...
main(void)
{
  ...
  19:	e8 6d 03 00 00       	call   38b <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 90 03 00 00       	call   3c3 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 84 03 00 00       	call   3c3 <dup>
  ...
  52:	e8 49 04 00 00       	call   4a0 <printf>
    pid = fork();
  57:	e8 e7 02 00 00       	call   343 <fork>
    if(pid < 0){
  ...
  70:	e8 de 02 00 00       	call   353 <wait>
  ...
  9a:	e8 01 04 00 00       	call   4a0 <printf>
      exit();
  9f:	e8 a7 02 00 00       	call   34b <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 24 0b 00 00       	push   $0xb24
  ab:	68 f6 07 00 00       	push   $0x7f6
  b0:	e8 ce 02 00 00       	call   383 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 dd 03 00 00       	call   4a0 <printf>
      exit();
  c3:	e8 83 02 00 00       	call   34b <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 c8 07 00 00       	push   $0x7c8
  d2:	e8 bc 02 00 00       	call   393 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 c8 07 00 00       	push   $0x7c8
  e0:	e8 a6 02 00 00       	call   38b <open>
 ...
 219:	31 db                	xor    %ebx,%ebx
{
 ...
 225:	57                   	push   %edi
 226:	6a 00                	push   $0x0
 228:	e8 36 01 00 00       	call   363 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 f9 00 00 00       	call   38b <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 fc 00 00 00       	call   3a3 <fstat>
  close(fd);
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 46e:	56                   	push   %esi
 46f:	57                   	push   %edi
 470:	e8 f6 fe ff ff       	call   36b <write>
  while(--i >= 0)
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e5:	57                   	push   %edi
 4e6:	56                   	push   %esi
 4e7:	e8 7f fe ff ff       	call   36b <write>
 ...
 53e:	e8 28 fe ff ff       	call   36b <write>
        putc(fd, c);
 ...
 54f:	57                   	push   %edi
 550:	56                   	push   %esi
 551:	e8 15 fe ff ff       	call   36b <write>
        putc(fd, c);
 ...
 5bb:	57                   	push   %edi
 5bc:	56                   	push   %esi
 5bd:	e8 a9 fd ff ff       	call   36b <write>
        while(*s != 0){
 ...
 5fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5ff:	e8 67 fd ff ff       	call   36b <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 733:	e8 9b fc ff ff       	call   3d3 <sbrk>
  if(p == (char*)-1)
