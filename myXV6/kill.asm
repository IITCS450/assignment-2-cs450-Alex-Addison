...
main(int argc, char **argv)
{
  ...
  39:	e8 ad 02 00 00       	call   2eb <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 71 02 00 00       	call   2bb <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 b8 03 00 00       	call   410 <printf>
    exit();
  58:	e8 5e 02 00 00       	call   2bb <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 36 01 00 00       	call   2d3 <read>
    if(cc < 1)
...
SYSCALL(setpriority)
 2ab:	b8 16 00 00 00       	mov    $0x16,%eax
 2b0:	cd 40                	int    $0x40
 2b2:	c3                   	ret    
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 455:	57                   	push   %edi
 456:	56                   	push   %esi
 457:	e8 7f fe ff ff       	call   2db <write>
 ...
 4ae:	e8 28 fe ff ff       	call   2db <write>
        putc(fd, c);
 ...
 52b:	57                   	push   %edi
 52c:	56                   	push   %esi
 52d:	e8 a9 fd ff ff       	call   2db <write>
        while(*s != 0){
 ...
 56c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 56f:	e8 67 fd ff ff       	call   2db <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6a3:	e8 9b fc ff ff       	call   343 <sbrk>
  if(p == (char*)-1)
