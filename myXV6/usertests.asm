...
00000200 <exitiputtest>:
{
  ...
  pid = fork();
     216:	e8 b8 36 00 00       	call   38d3 <fork>
  if(pid < 0){
...
00000300 <openiputtest>:
{
  ...
  pid = fork();
     32d:	e8 a1 35 00 00       	call   38d3 <fork>
  if(pid < 0){
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  pid = fork();
     a3d:	e8 91 2e 00 00       	call   38d3 <fork>
  if(pid == 0){
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 a1 2e 00 00       	call   3903 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 76 2e 00 00       	call   38f3 <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 27 2e 00 00       	call   3903 <close>
     ...
     b11:	e8 e5 2d 00 00       	call   38fb <write>
    ...
    exit();
     b28:	e8 ae 2d 00 00       	call   38db <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 c2 2d 00 00       	call   3903 <close>
    wait();
     b41:	e8 9d 2d 00 00       	call   38e3 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 c4 2e 00 00       	call   3a30 <printf>
      exit();
     b6c:	e8 6a 2d 00 00       	call   38db <exit>
    ...
    exit();
     b7f:	e8 57 2d 00 00       	call   38db <exit>
    ...
    exit();
     b92:	e8 44 2d 00 00       	call   38db <exit>
     ...
     ba0:	e8 8b 2e 00 00       	call   3a30 <printf>
        exit();
     ba5:	e8 31 2d 00 00       	call   38db <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 09 2d 00 00       	call   38d3 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 f4 2c 00 00       	call   38d3 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 ef 2c 00 00       	call   38eb <pipe>
  pid3 = fork();
     bfc:	e8 d2 2c 00 00       	call   38d3 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 c5 2c 00 00       	call   3903 <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 88 2c 00 00       	call   3903 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 7a 2c 00 00       	call   390b <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 72 2c 00 00       	call   390b <kill>
  kill(pid3);
  ...
  wait();
     caf:	e8 2f 2c 00 00       	call   38e3 <wait>
  wait();
     cb4:	e8 2a 2c 00 00       	call   38e3 <wait>
  wait();
     cb9:	e8 25 2c 00 00       	call   38e3 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 bc 2b 00 00       	call   38e3 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 9e 2b 00 00       	call   38d3 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 4c 2b 00 00       	call   38db <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 b0 2b 00 00       	call   395b <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 21 2b 00 00       	call   38d3 <fork>
    ...
    exit();
     e1f:	e8 b7 2a 00 00       	call   38db <exit>
     ...
     e3a:	e8 cc 2a 00 00       	call   390b <kill>
      exit();
     e3f:	e8 97 2a 00 00       	call   38db <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 90 2a 00 00       	jmp    38e3 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 aa 2a 00 00       	call   392b <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 93 41 00 00       	push   $0x4193
     e8d:	e8 89 2a 00 00       	call   391b <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 27 2a 00 00       	call   38d3 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 1a 2a 00 00       	call   38fb <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 d8 29 00 00       	call   38e3 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 ea 29 00 00       	call   3903 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 93 41 00 00       	push   $0x4193
     f22:	e8 f4 29 00 00       	call   391b <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 a2 29 00 00       	call   38f3 <read>
  ...
  close(fd);
     ...
     f86:	e8 78 29 00 00       	call   3903 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 93 41 00 00 	movl   $0x4193,(%esp)
     f92:	e8 94 29 00 00       	call   392b <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 db 28 00 00       	call   38db <exit>
    ...
    exit();
    100e:	e8 c8 28 00 00       	call   38db <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 c7 28 00 00       	call   392b <unlink>
    pid = fork();
    1064:	e8 6a 28 00 00       	call   38d3 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 56 28 00 00       	call   38e3 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 4f 28 00 00       	call   38e3 <wait>
    1094:	e8 4a 28 00 00       	call   38e3 <wait>
    1099:	e8 45 28 00 00       	call   38e3 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 69 28 00 00       	call   391b <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 1e 28 00 00       	call   38f3 <read>
    ...
    1104:	e8 fa 27 00 00       	call   3903 <close>
    if(total != 12*500){
    ...
    111e:	e8 08 28 00 00       	call   392b <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 d2 28 00 00       	call   3a30 <printf>
          exit();
    115e:	e8 78 27 00 00       	call   38db <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 aa 27 00 00       	call   391b <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 50 27 00 00       	call   38fb <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 1c 27 00 00       	call   38db <exit>
    ...
    11c8:	e8 63 28 00 00       	call   3a30 <printf>
        exit();
    11cd:	e8 09 27 00 00       	call   38db <exit>
    ...
    11e2:	e8 49 28 00 00       	call   3a30 <printf>
      exit();
    11e7:	e8 ef 26 00 00       	call   38db <exit>
    ...
    11f5:	e8 36 28 00 00       	call   3a30 <printf>
      exit();
    11fa:	e8 dc 26 00 00       	call   38db <exit>
    ...
    1208:	e8 23 28 00 00       	call   3a30 <printf>
          exit();
    120d:	e8 c9 26 00 00       	call   38db <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 94 26 00 00       	call   38d3 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 89 26 00 00       	call   38e3 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 7f 26 00 00       	call   38e3 <wait>
    1264:	e8 7a 26 00 00       	call   38e3 <wait>
    1269:	e8 75 26 00 00       	call   38e3 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 6d 26 00 00       	call   391b <open>
      if((i == 0 || i >= N/2) && fd < 0){
  ...
  printf(1, "createdelete ok\n");
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 7c 25 00 00       	call   391b <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 54 25 00 00       	call   3903 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 5d 25 00 00       	call   392b <unlink>
    ...
    13de:	e8 4d 26 00 00       	call   3a30 <printf>
            exit();
    13e3:	e8 f3 24 00 00       	call   38db <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 e6 24 00 00       	call   38db <exit>
    ...
    1400:	e8 2b 26 00 00       	call   3a30 <printf>
        exit();
    1405:	e8 d1 24 00 00       	call   38db <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 17 26 00 00       	call   3a30 <printf>
      exit();
    1419:	e8 bd 24 00 00       	call   38db <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 03 26 00 00       	call   3a30 <printf>
          exit();
    142d:	e8 a9 24 00 00       	call   38db <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 b6 24 00 00       	call   391b <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 79 24 00 00       	call   38fb <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 79 24 00 00       	call   3903 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 45 42 00 00       	push   $0x4245
    1493:	e8 83 24 00 00       	call   391b <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 79 24 00 00       	call   392b <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 4c 24 00 00       	call   391b <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 da 23 00 00       	call   38fb <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 d1 23 00 00       	call   3903 <close>
  unlink("unlinkread");
    1532:	c7 04 24 45 42 00 00 	movl   $0x4245,(%esp)
    1539:	e8 ed 23 00 00       	call   392b <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 72 23 00 00       	call   38db <exit>
    ...
    exit();
    1577:	e8 5f 23 00 00       	call   38db <exit>
    ...
    exit();
    158a:	e8 4c 23 00 00       	call   38db <exit>
    ...
    exit();
    159d:	e8 39 23 00 00       	call   38db <exit>
    ...
    exit();
    15b0:	e8 26 23 00 00       	call   38db <exit>
    ...
    exit();
    15c3:	e8 13 23 00 00       	call   38db <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 d2 22 00 00       	call   38fb <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 c5 22 00 00       	call   3903 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 0a 43 00 00       	push   $0x430a
    1645:	68 06 43 00 00       	push   $0x4306
    164a:	e8 ec 22 00 00       	call   393b <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 c4 22 00 00       	call   392b <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 06 43 00 00       	push   $0x4306
    1670:	e8 a6 22 00 00       	call   391b <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 8c 22 00 00       	call   391b <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 44 22 00 00       	call   38f3 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 3f 22 00 00       	call   3903 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 0a 43 00 00       	push   $0x430a
    16cb:	68 0a 43 00 00       	push   $0x430a
    16d0:	e8 66 22 00 00       	call   393b <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 3e 22 00 00       	call   392b <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 06 43 00 00       	push   $0x4306
    16f4:	68 0a 43 00 00       	push   $0x430a
    16f9:	e8 3d 22 00 00       	call   393b <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 24 22 00 00       	call   393b <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 93 21 00 00       	call   38db <exit>
    ...
    exit();
    1756:	e8 80 21 00 00       	call   38db <exit>
    ...
    exit();
    1769:	e8 6d 21 00 00       	call   38db <exit>
    ...
    exit();
    177c:	e8 5a 21 00 00       	call   38db <exit>
    ...
    exit();
    178f:	e8 47 21 00 00       	call   38db <exit>
    ...
    exit();
    17a2:	e8 34 21 00 00       	call   38db <exit>
    ...
    exit();
    17b5:	e8 21 21 00 00       	call   38db <exit>
    ...
    exit();
    17c8:	e8 0e 21 00 00       	call   38db <exit>
    ...
    exit();
    17db:	e8 fb 20 00 00       	call   38db <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 ec 20 00 00       	call   391b <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 c1 20 00 00       	call   3903 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 99 20 00 00       	call   38e3 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 c9 20 00 00       	call   392b <unlink>
    pid = fork();
    1862:	e8 6c 20 00 00       	call   38d3 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 91 20 00 00       	call   391b <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 5a 20 00 00       	call   393b <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 fa 1f 00 00       	call   38e3 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 08 20 00 00       	call   391b <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 c7 1f 00 00       	call   38f3 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 8a 1f 00 00       	call   3903 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 f2 1e 00 00       	call   38d3 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 0b 1f 00 00       	call   391b <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 eb 1e 00 00       	call   3903 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 f9 1e 00 00       	call   391b <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 d9 1e 00 00       	call   3903 <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 e7 1e 00 00       	call   391b <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 c7 1e 00 00       	call   3903 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 d5 1e 00 00       	call   391b <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 b5 1e 00 00       	call   3903 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 aa 1f 00 00       	call   3a30 <printf>
      exit();
    1a86:	e8 50 1e 00 00       	call   38db <exit>
    ...
    exit();
    1a99:	e8 3d 1e 00 00       	call   38db <exit>
    ...
    1aac:	e8 7f 1f 00 00       	call   3a30 <printf>
        exit();
    1ab1:	e8 25 1e 00 00       	call   38db <exit>
    ...
    1ac4:	e8 67 1f 00 00       	call   3a30 <printf>
        exit();
    1ac9:	e8 0d 1e 00 00       	call   38db <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 2c 1e 00 00       	call   3903 <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 2a 1e 00 00       	call   392b <unlink>
  pid = fork();
    1b01:	e8 cd 1d 00 00       	call   38d3 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 e9 1d 00 00       	call   392b <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 a0 1d 00 00       	call   391b <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 80 1d 00 00       	call   3903 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 4c 1d 00 00       	call   38e3 <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 79 1d 00 00       	call   393b <link>
    ...
    exit();
    1bd8:	e8 fe 1c 00 00       	call   38db <exit>
    exit();
    1bdd:	e8 f9 1c 00 00       	call   38db <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 1a 1d 00 00       	call   392b <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 55 44 00 00       	push   $0x4455
    1c1d:	e8 f9 1c 00 00       	call   391b <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 c8 1c 00 00       	call   3903 <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 cf 1c 00 00       	call   393b <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 9e 1c 00 00       	call   392b <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 74 1c 00 00       	call   392b <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 3e 1d 00 00       	call   3a30 <printf>
      exit();
    1cf2:	e8 e4 1b 00 00       	call   38db <exit>
    ...
    1d01:	e8 2a 1d 00 00       	call   3a30 <printf>
      exit();
    1d06:	e8 d0 1b 00 00       	call   38db <exit>
    ...
    exit();
    1d19:	e8 bd 1b 00 00       	call   38db <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 ec 1b 00 00       	call   392b <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 c8 45 00 00 	movl   $0x45c8,(%esp)
    1d46:	e8 f8 1b 00 00       	call   3943 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 b3 1b 00 00       	call   391b <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 76 1b 00 00       	call   38fb <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 76 1b 00 00       	call   3903 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 c8 45 00 00 	movl   $0x45c8,(%esp)
    1d94:	e8 92 1b 00 00       	call   392b <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 92 1b 00 00       	call   3943 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 4d 1b 00 00       	call   391b <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 10 1b 00 00       	call   38fb <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 10 1b 00 00       	call   3903 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 22 45 00 00       	push   $0x4522
    1dfc:	e8 1a 1b 00 00       	call   391b <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 d2 1a 00 00       	call   38f3 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 c0 1a 00 00       	call   3903 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 62 45 00 00       	push   $0x4562
    1e4a:	68 fe 44 00 00       	push   $0x44fe
    1e4f:	e8 e7 1a 00 00       	call   393b <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 bf 1a 00 00       	call   392b <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 95 1a 00 00       	call   391b <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 ad 1a 00 00       	call   394b <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 95 1a 00 00       	call   394b <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 7d 1a 00 00       	call   394b <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 65 1a 00 00       	call   394b <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 1b 1a 00 00       	call   391b <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 d3 19 00 00       	call   38f3 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 ce 19 00 00       	call   3903 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 fe 44 00 00       	push   $0x44fe
    1f3e:	e8 d8 19 00 00       	call   391b <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 bb 19 00 00       	call   391b <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 9e 19 00 00       	call   391b <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 81 19 00 00       	call   391b <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 67 19 00 00       	call   391b <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 4d 19 00 00       	call   391b <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 50 19 00 00       	call   393b <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 33 19 00 00       	call   393b <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 16 19 00 00       	call   393b <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 06 19 00 00       	call   3943 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 ee 18 00 00       	call   3943 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 d6 18 00 00       	call   3943 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 a6 18 00 00       	call   392b <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 8e 18 00 00       	call   392b <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 96 18 00 00       	call   394b <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 7e 18 00 00       	call   394b <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 46 18 00 00       	call   392b <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 2e 18 00 00       	call   392b <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 16 18 00 00       	call   392b <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 fe 17 00 00       	call   392b <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 e6 17 00 00       	call   392b <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 61 17 00 00       	call   38db <exit>
    ...
    exit();
    2188:	e8 4e 17 00 00       	call   38db <exit>
    ...
    exit();
    219b:	e8 3b 17 00 00       	call   38db <exit>
    ...
    exit();
    21ae:	e8 28 17 00 00       	call   38db <exit>
    ...
    exit();
    21c1:	e8 15 17 00 00       	call   38db <exit>
    ...
    exit();
    21d4:	e8 02 17 00 00       	call   38db <exit>
    ...
    exit();
    21e7:	e8 ef 16 00 00       	call   38db <exit>
    ...
    exit();
    21fa:	e8 dc 16 00 00       	call   38db <exit>
    ...
    exit();
    220d:	e8 c9 16 00 00       	call   38db <exit>
    ...
    exit();
    2220:	e8 b6 16 00 00       	call   38db <exit>
    ...
    exit();
    2233:	e8 a3 16 00 00       	call   38db <exit>
    ...
    exit();
    2246:	e8 90 16 00 00       	call   38db <exit>
    ...
    exit();
    2259:	e8 7d 16 00 00       	call   38db <exit>
    ...
    exit();
    226c:	e8 6a 16 00 00       	call   38db <exit>
    ...
    exit();
    227f:	e8 57 16 00 00       	call   38db <exit>
    ...
    exit();
    2292:	e8 44 16 00 00       	call   38db <exit>
    ...
    exit();
    22a5:	e8 31 16 00 00       	call   38db <exit>
    ...
    exit();
    22b8:	e8 1e 16 00 00       	call   38db <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 0b 16 00 00       	call   38db <exit>
    ...
    exit();
    22de:	e8 f8 15 00 00       	call   38db <exit>
    ...
    exit();
    22f1:	e8 e5 15 00 00       	call   38db <exit>
    ...
    exit();
    2304:	e8 d2 15 00 00       	call   38db <exit>
    ...
    exit();
    2317:	e8 bf 15 00 00       	call   38db <exit>
    ...
    exit();
    232a:	e8 ac 15 00 00       	call   38db <exit>
    ...
    exit();
    233d:	e8 99 15 00 00       	call   38db <exit>
    ...
    exit();
    2350:	e8 86 15 00 00       	call   38db <exit>
    ...
    exit();
    2363:	e8 73 15 00 00       	call   38db <exit>
    ...
    exit();
    2376:	e8 60 15 00 00       	call   38db <exit>
    ...
    exit();
    2389:	e8 4d 15 00 00       	call   38db <exit>
    ...
    exit();
    239c:	e8 3a 15 00 00       	call   38db <exit>
    ...
    exit();
    23af:	e8 27 15 00 00       	call   38db <exit>
    ...
    exit();
    23c2:	e8 14 15 00 00       	call   38db <exit>
    ...
    exit();
    23d5:	e8 01 15 00 00       	call   38db <exit>
    ...
    exit();
    23e8:	e8 ee 14 00 00       	call   38db <exit>
    ...
    exit();
    23fb:	e8 db 14 00 00       	call   38db <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 06 15 00 00       	call   392b <unlink>
    ...
    243d:	e8 d9 14 00 00       	call   391b <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 a1 14 00 00       	call   38fb <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 8b 14 00 00       	call   38fb <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 7d 14 00 00       	call   3903 <close>
    unlink("bigwrite");
    2486:	c7 04 24 c4 47 00 00 	movl   $0x47c4,(%esp)
    248d:	e8 99 14 00 00       	call   392b <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 6c 15 00 00       	call   3a30 <printf>
        exit();
    24c4:	e8 12 14 00 00       	call   38db <exit>
    ...
    24d3:	e8 58 15 00 00       	call   3a30 <printf>
      exit();
    24d8:	e8 fe 13 00 00       	call   38db <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 2a 14 00 00       	call   392b <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 20 48 00 00       	push   $0x4820
    250d:	e8 09 14 00 00       	call   391b <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 ad 13 00 00       	call   38fb <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 96 13 00 00       	call   3903 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 20 48 00 00       	push   $0x4820
    2576:	e8 a0 13 00 00       	call   391b <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 22 13 00 00       	call   38f3 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 20 13 00 00       	call   3903 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 2c 13 00 00       	call   392b <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 09 14 00 00       	call   3a30 <printf>
      exit();
    2627:	e8 af 12 00 00       	call   38db <exit>
    ...
    2636:	e8 f5 13 00 00       	call   3a30 <printf>
      exit();
    263b:	e8 9b 12 00 00       	call   38db <exit>
    ...
    264a:	e8 e1 13 00 00       	call   3a30 <printf>
      exit();
    264f:	e8 87 12 00 00       	call   38db <exit>
    ...
    265e:	e8 cd 13 00 00       	call   3a30 <printf>
      exit();
    2663:	e8 73 12 00 00       	call   38db <exit>
    ...
    exit();
    2676:	e8 60 12 00 00       	call   38db <exit>
    ...
    exit();
    2689:	e8 4d 12 00 00       	call   38db <exit>
    ...
    exit();
    269c:	e8 3a 12 00 00       	call   38db <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 75 12 00 00       	call   3943 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 5d 12 00 00       	call   3943 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 18 12 00 00       	call   391b <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 ec 11 00 00       	call   3903 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 78 51 00 00       	push   $0x5178
    2720:	e8 f6 11 00 00       	call   391b <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 ce 11 00 00       	call   3903 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 ec 48 00 00 	movl   $0x48ec,(%esp)
    273c:	e8 02 12 00 00       	call   3943 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 ee 11 00 00       	call   3943 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 58 11 00 00       	call   38db <exit>
    ...
    exit();
    2791:	e8 45 11 00 00       	call   38db <exit>
    ...
    exit();
    27a4:	e8 32 11 00 00       	call   38db <exit>
    ...
    exit();
    27b7:	e8 1f 11 00 00       	call   38db <exit>
    ...
    exit();
    27ca:	e8 0c 11 00 00       	call   38db <exit>
    ...
    exit();
    27dd:	e8 f9 10 00 00       	call   38db <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 35 11 00 00       	call   3943 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 25 11 00 00       	call   394b <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 ed 10 00 00       	call   392b <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 d5 10 00 00       	call   392b <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 dd 10 00 00       	call   394b <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 a5 10 00 00       	call   392b <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 91 10 00 00       	call   392b <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 7d 10 00 00       	call   392b <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 ff 0f 00 00       	call   38db <exit>
    ...
    exit();
    28ea:	e8 ec 0f 00 00       	call   38db <exit>
    ...
    exit();
    28fd:	e8 d9 0f 00 00       	call   38db <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 c6 0f 00 00       	call   38db <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 b3 0f 00 00       	call   38db <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 a0 0f 00 00       	call   38db <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 8d 0f 00 00       	call   38db <exit>
    ...
    exit();
    295c:	e8 7a 0f 00 00       	call   38db <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 87 0f 00 00       	call   391b <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 5b 0f 00 00       	call   3903 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 d5 49 00 00 	movl   $0x49d5,(%esp)
    29af:	e8 97 0f 00 00       	call   394b <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 4d 0f 00 00       	call   391b <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 30 0f 00 00       	call   391b <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 40 0f 00 00       	call   3943 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 10 0f 00 00       	call   392b <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 03 0f 00 00       	call   393b <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 db 0e 00 00       	call   392b <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 b1 0e 00 00       	call   391b <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 97 0e 00 00       	call   391b <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 65 0e 00 00       	call   38fb <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 5d 0e 00 00       	call   3903 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 0c 0e 00 00       	call   38db <exit>
    ...
    exit();
    2add:	e8 f9 0d 00 00       	call   38db <exit>
    ...
    exit();
    2af0:	e8 e6 0d 00 00       	call   38db <exit>
    ...
    exit();
    2b03:	e8 d3 0d 00 00       	call   38db <exit>
    ...
    exit();
    2b16:	e8 c0 0d 00 00       	call   38db <exit>
    ...
    exit();
    2b29:	e8 ad 0d 00 00       	call   38db <exit>
    ...
    exit();
    2b3c:	e8 9a 0d 00 00       	call   38db <exit>
    ...
    exit();
    2b4f:	e8 87 0d 00 00       	call   38db <exit>
    ...
    exit();
    2b62:	e8 74 0d 00 00       	call   38db <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 a6 0d 00 00       	call   3943 <mkdir>
    ...
    2bb0:	e8 96 0d 00 00       	call   394b <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 df 0c 00 00       	call   3903 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 b0 46 00 00       	push   $0x46b0
    2c2f:	e8 f7 0c 00 00       	call   392b <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 fe 0c 00 00       	call   394b <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 be 0d 00 00       	call   3a30 <printf>
      exit();
    2c72:	e8 64 0c 00 00       	call   38db <exit>
    ...
    2c81:	e8 aa 0d 00 00       	call   3a30 <printf>
      exit();
    2c86:	e8 50 0c 00 00       	call   38db <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 11 0c 00 00       	call   38d3 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 0e 0c 00 00       	call   38e3 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 00 0c 00 00       	call   38e3 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 da 0b 00 00       	call   38db <exit>
    ...
    2d0b:	e8 20 0d 00 00       	call   3a30 <printf>
      exit();
    2d10:	e8 c6 0b 00 00       	call   38db <exit>
    ...
    exit();
    2d23:	e8 b3 0b 00 00       	call   38db <exit>
    ...
    exit();
    2d36:	e8 a0 0b 00 00       	call   38db <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  oldbrk = sbrk(0);
    ...
    2d62:	e8 fc 0b 00 00       	call   3963 <sbrk>
  a = sbrk(0);
    2d67:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d6e:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d71:	e8 ed 0b 00 00       	call   3963 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 d7 0b 00 00       	call   3963 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 26 0b 00 00       	call   38d3 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 9f 0b 00 00       	call   3963 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 93 0b 00 00       	call   3963 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 fb 0a 00 00       	call   38e3 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 71 0b 00 00       	call   3963 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 60 0b 00 00       	call   3963 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e18:	6a 00                	push   $0x0
    2e1a:	e8 44 0b 00 00       	call   3963 <sbrk>
  c = sbrk(-4096);
    2e1f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e26:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e28:	e8 36 0b 00 00       	call   3963 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e3c:	6a 00                	push   $0x0
    2e3e:	e8 20 0b 00 00       	call   3963 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e57:	6a 00                	push   $0x0
    2e59:	e8 05 0b 00 00       	call   3963 <sbrk>
  c = sbrk(4096);
    2e5e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e65:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e67:	e8 f7 0a 00 00       	call   3963 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e7c:	6a 00                	push   $0x0
    2e7e:	e8 e0 0a 00 00       	call   3963 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2edf:	90                   	nop
    ppid = getpid();
    2ee0:	e8 76 0a 00 00       	call   395b <getpid>
    2ee5:	89 c6                	mov    %eax,%esi
    pid = fork();
    2ee7:	e8 e7 09 00 00       	call   38d3 <fork>
    if(pid < 0){
    ...
    wait();
    2efa:	e8 e4 09 00 00       	call   38e3 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f13:	50                   	push   %eax
    2f14:	e8 d2 09 00 00       	call   38eb <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f30:	e8 9e 09 00 00       	call   38d3 <fork>
    ...
    2f50:	e8 9e 09 00 00       	call   38f3 <read>
  ...
  c = sbrk(4096);
    ...
    2f67:	e8 f7 09 00 00       	call   3963 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f82:	50                   	push   %eax
    2f83:	e8 83 09 00 00       	call   390b <kill>
    wait();
    2f88:	e8 56 09 00 00       	call   38e3 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fa3:	6a 00                	push   $0x0
    2fa5:	e8 b9 09 00 00       	call   3963 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    304c:	e8 8a 08 00 00       	call   38db <exit>
      printf(stdout, "fork failed\n");
    ...
    305f:	e8 cc 09 00 00       	call   3a30 <printf>
      exit();
    3064:	e8 72 08 00 00       	call   38db <exit>
    ...
    3081:	e8 85 08 00 00       	call   390b <kill>
      exit();
    3086:	e8 50 08 00 00       	call   38db <exit>
    ...
    exit();
    309d:	e8 39 08 00 00       	call   38db <exit>
    ...
    exit();
    30b4:	e8 22 08 00 00       	call   38db <exit>
    ...
    exit();
    30cb:	e8 0b 08 00 00       	call   38db <exit>
    ...
    exit();
    30e2:	e8 f4 07 00 00       	call   38db <exit>
    ...
    exit();
    30f9:	e8 dd 07 00 00       	call   38db <exit>
    printf(1, "pipe() failed\n");
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    ...
    exit();
    310c:	e8 ca 07 00 00       	call   38db <exit>
    exit();
    3111:	e8 c5 07 00 00       	call   38db <exit>
    ...
    exit();
    3128:	e8 ae 07 00 00       	call   38db <exit>
    ...
    exit();
    313f:	e8 97 07 00 00       	call   38db <exit>
    ...
    exit();
    3156:	e8 80 07 00 00       	call   38db <exit>
    ...
    exit();
    316d:	e8 69 07 00 00       	call   38db <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    if((pid = fork()) == 0){
    31b0:	e8 1e 07 00 00       	call   38d3 <fork>
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 a6 07 00 00       	call   396b <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 9a 07 00 00       	call   396b <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 32 07 00 00       	call   390b <kill>
    wait();
    31d9:	e8 05 07 00 00       	call   38e3 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 0d 4c 00 00       	push   $0x4c0d
    31e6:	e8 50 07 00 00       	call   393b <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 b8 06 00 00       	call   38db <exit>
    ...
    3231:	e8 fa 07 00 00       	call   3a30 <printf>
      exit();
    3236:	e8 a0 06 00 00       	call   38db <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    3299:	e8 92 07 00 00       	call   3a30 <printf>
      exit();
    329e:	e8 38 06 00 00       	call   38db <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 6b 06 00 00       	call   392b <unlink>
  pid = fork();
    32c0:	e8 0e 06 00 00       	call   38d3 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 0c 06 00 00       	call   38e3 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 66 4c 00 00       	push   $0x4c66
    32e1:	e8 35 06 00 00       	call   391b <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 09 06 00 00       	call   3903 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 66 4c 00 00 	movl   $0x4c66,(%esp)
    3301:	e8 25 06 00 00       	call   392b <unlink>
}
    ...
    334b:	e8 c3 05 00 00       	call   3913 <exec>
    ...
    336e:	e8 a8 05 00 00       	call   391b <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 88 05 00 00       	call   3903 <close>
    exit();
    337b:	e8 5b 05 00 00       	call   38db <exit>
    ...
    exit();
    3392:	e8 44 05 00 00       	call   38db <exit>
    ...
    exit();
    33a9:	e8 2d 05 00 00       	call   38db <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 bd 04 00 00       	call   391b <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 76 04 00 00       	call   38fb <write>
      if(cc < 512)
    ...
    34a2:	e8 5c 04 00 00       	call   3903 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 da 03 00 00       	call   392b <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 3c 03 00 00       	call   38d3 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 3e 03 00 00       	call   38e3 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 fe 02 00 00       	call   38db <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 eb 02 00 00       	call   38db <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 18 03 00 00       	call   391b <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 4d 03 00 00       	call   3963 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 ce 02 00 00       	call   38f3 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 d6 02 00 00       	call   3903 <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3651:	e8 85 02 00 00       	call   38db <exit>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 36 01 00 00       	call   38f3 <read>
    if(cc < 1)
...
SYSCALL(setpriority)
    38cb:	b8 16 00 00 00       	mov    $0x16,%eax
    38d0:	cd 40                	int    $0x40
    38d2:	c3                   	ret    

000038d3 <fork>:
SYSCALL(fork)
    38d3:	b8 01 00 00 00       	mov    $0x1,%eax
    38d8:	cd 40                	int    $0x40
    38da:	c3                   	ret    
    ...
    398c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    39fe:	56                   	push   %esi
    39ff:	57                   	push   %edi
    3a00:	e8 f6 fe ff ff       	call   38fb <write>
  while(--i >= 0)
    ...
    3a39:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3a75:	57                   	push   %edi
    3a76:	56                   	push   %esi
    3a77:	e8 7f fe ff ff       	call   38fb <write>
  ...
  write(fd, &c, 1);
    ...
    3ace:	e8 28 fe ff ff       	call   38fb <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b4b:	57                   	push   %edi
    3b4c:	56                   	push   %esi
    3b4d:	e8 a9 fd ff ff       	call   38fb <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3b8f:	e8 67 fd ff ff       	call   38fb <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cc3:	e8 9b fc ff ff       	call   3963 <sbrk>
  if(p == (char*)-1)
