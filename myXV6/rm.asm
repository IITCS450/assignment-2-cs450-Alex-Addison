...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 f1 02 00 00       	call   32b <unlink>
  ...
  exit();
  4b:	e8 8b 02 00 00       	call   2db <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  ...
  6d:	e8 be 03 00 00       	call   430 <printf>
    exit();
  72:	e8 64 02 00 00       	call   2db <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 36 01 00 00       	call   2f3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 f9 00 00 00       	call   31b <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 fc 00 00 00       	call   333 <fstat>
  close(fd);
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 475:	57                   	push   %edi
 476:	56                   	push   %esi
 477:	e8 7f fe ff ff       	call   2fb <write>
 ...
 4ce:	e8 28 fe ff ff       	call   2fb <write>
        putc(fd, c);
 ...
 4df:	57                   	push   %edi
 4e0:	56                   	push   %esi
 4e1:	e8 15 fe ff ff       	call   2fb <write>
        putc(fd, c);
 ...
 54b:	57                   	push   %edi
 54c:	56                   	push   %esi
 54d:	e8 a9 fd ff ff       	call   2fb <write>
        while(*s != 0){
 ...
 58c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 58f:	e8 67 fd ff ff       	call   2fb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6c3:	e8 9b fc ff ff       	call   363 <sbrk>
  if(p == (char*)-1)
