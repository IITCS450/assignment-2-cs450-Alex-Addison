...
80103bf9:	e8 e2 09 00 00       	call   801045e0 <release>
  return pid;
...
801042ed:	75 f1                	jne    801042e0 <setpriority+0x30>
801042ef:	8b 50 0c             	mov    0xc(%eax),%edx
801042f2:	85 d2                	test   %edx,%edx
801042f4:	74 ea                	je     801042e0 <setpriority+0x30>
      p->priority = prio;
      release(&ptable.lock);
801042f6:	83 ec 0c             	sub    $0xc,%esp
      p->priority = prio;
801042f9:	89 70 7c             	mov    %esi,0x7c(%eax)
      release(&ptable.lock);
