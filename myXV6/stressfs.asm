  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 30 03 00 00       	call   393 <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 33 03 00 00       	call   3db <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 fc 02 00 00       	call   3bb <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 f3 02 00 00       	call   3c3 <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 e8 02 00 00       	call   3db <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 a4 02 00 00       	call   3b3 <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 a3 02 00 00       	call   3c3 <close>

  wait();
 120:	e8 7e 02 00 00       	call   3a3 <wait>

  exit();
 125:	e8 71 02 00 00       	call   39b <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 36 01 00 00       	call   3b3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 f9 00 00 00       	call   3db <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 fc 00 00 00       	call   3f3 <fstat>
  close(fd);
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 535:	57                   	push   %edi
 536:	56                   	push   %esi
 537:	e8 7f fe ff ff       	call   3bb <write>
 ...
 58e:	e8 28 fe ff ff       	call   3bb <write>
        putc(fd, c);
 ...
 59f:	57                   	push   %edi
 5a0:	56                   	push   %esi
 5a1:	e8 15 fe ff ff       	call   3bb <write>
        putc(fd, c);
 ...
 60b:	57                   	push   %edi
 60c:	56                   	push   %esi
 60d:	e8 a9 fd ff ff       	call   3bb <write>
        while(*s != 0){
 ...
 64c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 64f:	e8 67 fd ff ff       	call   3bb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 783:	e8 9b fc ff ff       	call   423 <sbrk>
  if(p == (char*)-1)
